        ...
        <div id="register_form" class="form_01">   
            <div class="register_form_inner">
                ...
                <ul>
                    <li>
                        <label for="reg_mb_id">
                            아이디 <span class="sound_only">(필수)</span>
                    ...
                    <li class="half_input left_input margin_input">
                        <label for="reg_mb_password">비밀번호 <span class="sound_only">(필수)</span></label>
                    ...
                    <li class="half_input left_input">
                        <label for="reg_mb_password_re">비밀번호 확인 <span class="sound_only">(필수)</span></label>
            ...
            <div class="tbl_frm01 tbl_wrap register_form_inner">
                ...
                <ul>
                  <li>
                    ...
                    if ($config['cf_cert_use']) {
                      ...
                      if ($config['cf_cert_ipin'])
                        ...
                        echo '<span class="cert_req"><span class="sound_only">(필수)</span></span>';
                  ...
                  <li>
                      <label for="reg_mb_name">이름 <span class="sound_only">(필수)</span><?php echo $desc_name ?></label>
                  ...
                  <li>
                      <label for="reg_mb_nick">
                        닉네임 <span class="sound_only">(필수)</span>
                        <button type="button" class="tooltip_icon"><i class="fa fa-question-circle-o" aria-hidden="true"></i><span class="sound_only">설명보기</span></button>
                  ...
                  <li>
                      <label for="reg_mb_email">E-mail <span class="sound_only">(필수)</span>
                  ...
                  <li>
                      <label for="reg_mb_homepage">홈페이지<?php if ($config['cf_req_homepage']){ ?> <span class="sound_only">(필수)</span><?php } ?></label>
                  ...
                  <li>
                      ...
                      <label for="reg_mb_tel">전화번호<?php if ($config['cf_req_tel']) { ?> <span class="sound_only">(필수)</span><?php } ?></label>
                  ...
                  <li>
                    <?php if ($config['cf_use_hp'] || ($config["cf_cert_use"] && ($config['cf_cert_hp'] || $config['cf_cert_simple']))) {  ?>
                        <label for="reg_mb_hp">휴대폰번호<?php if (!empty($hp_required)) { ?> <span class="sound_only">(필수)</span><?php } ?><?php echo $desc_phone ?></label>
                  ...
                  <li>
                      <label>주소</label>
                      <?php if ($config['cf_req_addr']) { ?> <span class="sound_only">(필수)</span><?php }  ?>
                      <label for="reg_mb_zip" class="sound_only">우편번호<?php echo $config['cf_req_addr']?' <span class="sound_only">(필수)</span>':''; ?></label>
                      ...
                      <label for="reg_mb_addr1" class="sound_only">기본주소<?php echo $config['cf_req_addr']?' <span class="sound_only">(필수)</span>':''; ?></label><br>
            ...
            <div class="tbl_frm01 tbl_wrap register_form_inner">
                ...
                <ul>
                    ...
                    <li>
                        <label for="reg_mb_signature">서명<?php if ($config['cf_req_signature']){ ?> <span class="sound_only">(필수)</span><?php } ?></label>
