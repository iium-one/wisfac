            ...
            <form name="fsearch" id="fm-sch" method="get">
              ...
              <div class="sch_wrap">
                <select name="sfl" id="sfl" class="nc-sel sch-select">
                  <option value="wr_subject||wr_content" <?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>全て</option>
                  <option value="wr_subject" <?php echo get_selected($sfl, 'wr_subject'); ?>>タイトル</option>
                  <option value="wr_content" <?php echo get_selected($sfl, 'wr_content'); ?>>内容</option>
                </select>
                <input type="text" name="stx" id="stx" class="sch-keyword" value="<?php echo stripslashes($stx) ?>" required size="25" maxlength="20" placeholder="検索ワードを入力してください。">
