...
<div id="news" class="contents">
  ...
  <div id="sb-contents">
    <section class="board-write">
      <h2 class="sound_only">회사소식 작성페이지</h2>
      <div class="container">
        <div class="wrapper">
          <div class="sec_ct">
            ...
            <section id="bo_w">
              ...
              <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
                ...
                <div class="bo_w_tit write_div">
                  ...
                  <div class="write_div">
                    <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-input full required" size="50" maxlength="255" placeholder="제목">
                  </div>
                </div>
                ...
                <div class="btn_confirm write_div">
                  <ul class="i-col-0 btn_confirm_ul">
                    <li>
                      <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_cancel bo_btn2">취소</a>
                    </li>
                    <li>
                      <button type="submit" id="btn_submit" accesskey="s" class="btn_submit bo_btn1">작성완료</button>
                    </li>
                  </ul>
                </div>
              </form>
