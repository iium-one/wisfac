...
<div id="bo_v_cmt">
  ...
  <section id="bo_vc">
    ...
    for ($i=0; $i<$cmt_amt; $i++) {
      ...
      $cmt_depth_num = strlen($list[$i]['wr_comment_reply']);
        ...
        <header style="z-index:<?php echo $cmt_sv; ?>">
          ...
          <div class="bo_vl_opt">
            <ul class="i-col-0  bo_vc_act">
              ...
              <li>
                <a href="<?php echo $c_edit_href; ?>" class="bo_btn2" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;">수정</a>
              </li>
              <?php } ?>
              <?php if ($list[$i]['is_del']) { ?>
              <li>
                <a href="<?php echo $list[$i]['del_link']; ?>" class="bo_btn3" onclick="return comment_delete();">삭제</a>
              </li>
              <?php } ?>
            </ul>
          </div>
