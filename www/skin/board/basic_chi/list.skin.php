            ...
            <form name="fsearch" id="fm-sch" method="get">
              ...
              <div class="sch_wrap">
                <select name="sfl" id="sfl" class="nc-sel sch-select">
                  <option value="wr_subject||wr_content" <?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>整个</option>
                  <option value="wr_subject" <?php echo get_selected($sfl, 'wr_subject'); ?>>题目</option>
                  <option value="wr_content" <?php echo get_selected($sfl, 'wr_content'); ?>>内容</option>
                </select>
                <input type="text" name="stx" id="stx" class="sch-keyword" value="<?php echo stripslashes($stx) ?>" required size="25" maxlength="20" placeholder="请输入搜索语。">
                <button type="submit" class="sch-submit" title="搜索"></button>
              </div>
                ...
                <div class="board-list_wrap">
                  ...
                  <div class="board-list-item">
                    ...
                    <div class="date">
                      ...
                      <a href="<?php echo $list[$i]['href'] ?>" class="more-btn">学习更多<img src="/source/img/arrow-right-red.png" alt=""></a>
                    </div>
                  </div>
                  <?php 
                  }
                  if (count($list) == 0) {
                    echo '<div class="empty_table">没有资料。</div>';
                  }
                  ?>
