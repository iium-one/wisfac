...
<div id="product" class="contents view">
  ...
  <div id="sb-contents">
    <div class="container">
      <div class="wrapper">
        <a href="/jpn/sub/prod_list/<?php echo $prod_item['ca_id'];?>" class="prod_detail_back"><img src="/source/img/arrow-left-gray.png" alt=""><?php echo $prod_item['ca_1_subj'];?> 全体を見る</a>
      </div>
    </div>
