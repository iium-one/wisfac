            ...
            <div class="match-height dgtxt-wrap aboutus-slo cd4">
              <div class="dgtxt-list">
                <div class="dgtxt-list-in">
                  <p class="dgtxt-text1">기술혁신</p>
                  <p class="dgtxt-text2">특허 취득, 첨단 기술 집약, Ai적용</p>
                </div>
              </div>
              <div class="dgtxt-list">
                <div class="dgtxt-list-in">
                  <p class="dgtxt-text1">제품다양화</p>
                  <p class="dgtxt-text2">다양한 Wafer Inspection에 맞춘 장비 생산</p>
                </div>
              </div>
              <div class="dgtxt-list">
                <div class="dgtxt-list-in">
                  <p class="dgtxt-text1">글로벌 기업성장</p>
                  <p class="dgtxt-text2">아시아를 넘어 유럽, 미주 고객사 확보</p>
                </div>
              </div>
              <div class="dgtxt-list">
                <div class="dgtxt-list-in">
                  <p class="dgtxt-text1">기업인재</p>
                  <p class="dgtxt-text2">체계적인 인재 선발과 육성을 통해 기업 역량 강화</p>
                </div>
              </div>
            </div>
          </div>
